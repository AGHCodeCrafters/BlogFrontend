...
const CategoryBox = (props) => {
  ...
  return (
    <ul className="min-h-[50px] md:min-h-[70px] lg:min-h-[45px] p-[10px] mt-[20px] flex items-center justify-between gap-5 overflow-x-auto overflow-y-hidden scroll bg-blue rounded-md cursor-pointer">
      {categoriesList.map((obj, index) => (
        <li
          key={index}
          className={`p-[5px] text-white text-16px md:text-[18px] lg:text-[14px] font-medium border-2 rounded-md ${
